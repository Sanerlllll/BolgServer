<template>
  <div class="app-container">
    ...
    <div style="margin-bottom:15px;width:500px">
      <el-input 
      v-model="form.github" disabled></el-input>
    </div>
    <el-divider></el-divider>
    ...
    <div style="margin-bottom:15px;width:500px">
      <el-input 
      v-model="form.qq" disabled></el-input>
    </div>
    ...
    <div style="margin-bottom:15px;width:500px">
      <el-input 
      v-model="form.weixin" disabled></el-input>
    </div>
    ...
    >
      <el-form :model="form">
        ...
        </el-form-item><el-form-item label="QQ二维码地址">
          <!-- <el-input v-model="form2.qqQrCode"></el-input> -->
          <Upload v-model="form2.qqQrCode"></Upload>
        </el-form-item><el-form-item label="微信号码">
          <el-input v-model="form2.weixin"></el-input>
        </el-form-item>
        <el-form-item label="微信二维码地址">
          <!-- <el-input v-model="form2.weixinQrCode2"></el-input> -->
